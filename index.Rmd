...
We have a few exciting, ongoing projects that span across my long-term interests in learning and memory, feeding behavior, sex differences, and the underlying neural systems and circuit-level plasticity. They also reflect my current interests in novelty processing and hedonic eating. Our most recent publication examined how novelty impacts feeding in male and female rats and found robust sex differences in habituation and currently we are identifying key neural substrates. Other projects are focused on the medial prefrontal cortex plasticity and the role of the paraventricular nucleus of the thalamus in context-mediated renewal of responding to food cues. We are also following up, with behavioral and neural analyses, on interesting sex differences in hedonic eating we recently observed; when fed palatable food, female rats consumed large amounts regardless of their hunger state, while males adjusted their consumption according to their physiological hunger/satiety. 
...
Initially, we were surprised to find that female rats inhibited feeding much longer than males when repeatedly tested with a fear cue. Since then we have found similar effects—prolonged cessation of feeding in females compared to males—with aversive discrete and contextual conditioned stimuli and, most recently, when rats were habituating to eating novel food in a novel context. These findings indicate a stronger drive in females to sustain low food intake when faced with danger or uncertainty.
